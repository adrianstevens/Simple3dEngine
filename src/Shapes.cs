    ...
    public static class Shapes
    {
        ...
        public static Mesh GenerateTetrahedron()
        {
            ...
            Mesh tetrahedron = new Mesh
            {
                ...
                {
                    // Base
                    new Triangle(new Vector3d(0, 0, 0), new Vector3d(edge, 0, 0), new Vector3d(edge / 2, edge * sqrt2 / 2, 0)),
                    // Sides
                    new Triangle(new Vector3d(0, 0, 0), new Vector3d(edge / 2, edge * sqrt2 / 2, 0), new Vector3d(edge / 2, edge * sqrt2 / 6, edge * sqrt2 * 2 / 3)),
        ...
        {
            float t = (1.0f + (float)Math.Sqrt(5.0f)) / 2.0f; // golden ratio
            float s = 1.0f;
